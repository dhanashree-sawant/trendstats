    ...
    <div className="rounded-sm border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
      ...
      <div className="flex flex-col">
        <div className="grid grid-cols-3 rounded-sm bg-gray-2 dark:bg-meta-4 sm:grid-cols-9">
          <div className="p-1.5 text-center xl:py-5 xl:px-2">
          ...
          <div className="hidden p-1.5 text-center sm:block xl:py-5 xl:px-2">
            <h5 className="text-xsm font-medium uppercase xsm:text-base">
              Buy Price
            </h5>
          </div>
        ...
        {brandData.map((brand, key) => (
          <div
            ...
            key={key}
          >
            <div className="flex items-center justify-center p-1.5 xl:py-5 xl:px-2">
            ...
            <div className="hidden items-center justify-center p-1.5 sm:flex xl:py-5 xl:px-2">
